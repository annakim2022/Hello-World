...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("Data from Main Activity", receivedMessage); // not working
        ...
        // this is how to create views if you do not know how many views you will need to create (i.e. HW1)
        */
         ...
         client.get(api_url, new AsyncHttpResponseHandler() {
             ...
             public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                 ...
                 try {
                     ...
                     // when you receive the intent in the next activity, convert it back to the json data
